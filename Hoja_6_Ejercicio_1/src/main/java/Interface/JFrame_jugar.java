 ...
 * @author usuario
 */
public class JFrame_jugar extends javax.swing.JFrame
{

    /**
     * Creates new form JFrame_jugar
     */
    public JFrame_jugar()
    {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jTextField_nombreUsuario.setText("nombre usuario");
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(JFrame_jugar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new JFrame_jugar().setVisible(true);
            }
        });
    }
